# Generated by Django 3.0.6 on 2020-05-18 01:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='bookflix/static/autores')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('reading', 'reading'), ('future_reading', 'future_reading'), ('finished', 'finished')], default='finished', max_length=16)),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookflix.Book')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookflix.Profile')),
            ],
            options={
